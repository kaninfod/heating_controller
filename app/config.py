...
class Settings(BaseSettings):
    ...
    # Area filtering
    blacklisted_areas: str = Field(default="", alias="BLACKLISTED_AREAS")
    ...
    @property
    def blacklisted_areas_list(self) -> list[str]:
        """Parse comma-separated blacklisted areas into list"""
        return [a.strip() for a in self.blacklisted_areas.split(",") if a.strip()]
