...
class DayType(BaseModel):
    ...
    id: str
    schedule: str  # TRVZB format: "HH:MM/TEMP HH:MM/TEMP ..." (6 pairs starting with 00:00)
...
class SystemMode(str, Enum):
    ...
    STAY_HOME = "stay_home"  # Dynamic: swap current day to weekend, support active zones
